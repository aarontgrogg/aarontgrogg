...
<?php if ( ! have_posts() ) : ?>
	<article itemscope itemType="http://schema.org/BlogPosting" id="post-0" class="post error404 not-found">
		<h1 itemprop="headline" class="entry-title"><?php _e( 'Not Found', 'boilerplate' ); ?></h1>
...
<?php /* How to display posts in the Gallery category. */ ?>
	...
	<?php if ( in_category( _x('gallery', 'gallery category slug', 'boilerplate') ) ) : ?>
		<article itemscope itemType="http://schema.org/BlogPosting" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<header>
				<h1 itemprop="headline" class="entry-title"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'boilerplate' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h1>
			</header>
...
<?php /* How to display all other posts. */ ?>
	...
	<?php else : ?>
		<article itemscope itemType="http://schema.org/BlogPosting" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<header>
				<h1 itemprop="headline" class="entry-title"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'boilerplate' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark" prerender><?php the_title(); ?></a></h1>
			</header>
